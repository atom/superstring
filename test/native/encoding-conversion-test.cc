...
TEST_CASE("EncodingConversion::decode - can decode a UTF-8 stream") {
...
TEST_CASE("EncodingConversion::decode - can decode an ISO-8859-1 stream") {
  auto conversion = transcoding_from("ISO-8859-1");
  stringstream stream("qrst" "\xfc" "v", std::ios_base::in); // qrstüv
