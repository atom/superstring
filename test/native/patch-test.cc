...
TEST_CASE("Patch::find_changes_in_new_range") {
  ...
  REQUIRE(patch.find_changes_in_new_range(Point{0, 12}, Point{0, 20}) == vector<Change>({
    Change {
      Point {0, 2}, Point {0, 4},
      Point {0, 12}, Point {0, 13},
      nullptr, nullptr,
  ...
  REQUIRE(patch.find_changes_in_new_range(Point{0, 12}, Point{0, 15}) == vector<Change>({
    Change {
      Point {0, 2}, Point {0, 4},
      Point {0, 12}, Point {0, 13},
      nullptr, nullptr,
